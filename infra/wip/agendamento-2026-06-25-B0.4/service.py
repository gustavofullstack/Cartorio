...
class AgendamentoService:
    ...
    def _validar_horario_disponivel(
        ...
        stmt = select(Agendamento).where(
            ...
            # Sobreposição: (A começa durante B) OU (A termina durante B)
            # A = novo agendamento, B = existente
            # (data_hora < b.data_hora_fim) AND (data_hora_fim > b.data_hora)
            (
    ...
    def criar_agendamento(
        ...
        *,
        ...
        duration_minutes: int = 30,
        request: Annotated[object, "FastAPI Request"] | None = None,
    ) -> Agendamento:
        ...
        cliente = AgendamentoService._validar_cliente_existe(db, cliente_id)
        protocolo = AgendamentoService._validar_protocolo_existe(db, protocolo_id)
        ...
        AuditService.log(
            ...
            payload={
                "cliente_id": cliente_id,
                "cliente_cpf_hash": hash_pii(cliente_cpf),
