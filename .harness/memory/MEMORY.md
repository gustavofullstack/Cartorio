...
### Etapa 12 — Super Backup WhatsApp & Agent Pietra MiniMax M3 Autônomo (2026-08-10..2026-08-18)
- **Lesson 302 — Revisão Operacional Balcão 2026 & Desambiguação de Procurações (2026-08-18)**: Consolidação do relatório de valores individualizados de balcão (03/08/2026, Felipe Pizarro) e regras administrativas. (1) `autenticacao_documento_eletronico` corrigida para R$ 13,91; adicionados DUT/ATPV (R$ 16,61 com CNTV/MG) e xerox (R$ 1,80 / R$ 3,60); (2) Desambiguação obrigatória de procuração antes de informar valores (Genérica R$ 71,38, Financeira R$ 226,14, INSS R$ 37,91); (3) Atos simples de balcão bloqueados para pré-agendamento (atendimento presencial por ordem de chegada com senhas preferenciais para idosos, autistas, advogados e PCDs); (4) Separação explícita no MCP `cartorio_calcular_emolumento` entre camada regulatória TJMG (`regulatory_tjmg`) e camada operacional da serventia (`operational_pos_2notas`); (5) Canned responses sanitizadas de placeholders antigos; (6) 2 divergências fiscais mantidas sem inferência, informando apenas totais consolidados. Detalhe: `.harness/memory/lesson-302-manual-revisao-balcao-procuracoes-2026-08-18.md` e `docs/MANUAL_TREINAMENTO_CHATBOT_REVISADO_2026-08-18.md`.
