...
FAKE_TOKEN = "123456789:AAfakeTokenGateE310-abcdefghij"  # ALLOW_KEY_FALLBACK (motivo: token Telegram SINTETICO formato 123456789:AAfake... — exercita _strip_secrets do gate MCP)
