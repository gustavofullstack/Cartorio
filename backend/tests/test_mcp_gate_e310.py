...
FAKE_TOKEN = "123456789:AAfakeTokenGateE310-abcdefghij"  # noqa: F401, F841  # ALLOW_KEY_FALLBACK (motivo: token Telegram SINTETICO formato 123456789:AAfake... — exercita _strip_secrets do gate MCP)
