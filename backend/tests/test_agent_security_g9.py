...
class TestPayloadSemSecrets:
    ...
    async def test_body_llm_nao_contem_valores_secret_env(
        ...
        secret_value = "sk-cp-FAKESECRET-G9S3-NAO-PODE-VAZAR"  # noqa (motivo: chave MiniMax SINTETICA de fixture — formato realista p/ testar gate de seguranca S3, sem valor real)
