...
<head>
  ...
  <style>
    ...
    .header-cartorio .links a {{ color: #cbd5e0; margin-left: 18px; text-decoration: none; padding: 4px 8px; border-radius: 4px; transition: all 0.2s; }}
    .header-cartorio .links a:hover {{ color: white; background: rgba(255,255,255,0.1); text-decoration: none; }}
    .header-cartorio .links a:focus-visible {{ outline: 2px solid white; outline-offset: 2px; color: white; }}
  </style>
</head>
<body>
