...
<head>
  ...
  <style>
    ...
    .header-cartorio .links a {{ color: #cbd5e0; margin-left: 18px; text-decoration: none; transition: color 0.2s; }}
    .header-cartorio .links a:hover {{ color: white; text-decoration: underline; }}
    .header-cartorio .links a:focus-visible {{ outline: 2px solid white; outline-offset: 2px; border-radius: 4px; }}
  </style>
</head>
<body>
