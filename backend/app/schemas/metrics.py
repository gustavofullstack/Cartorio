...
class MetricsResponse(BaseModel):
    ...
    audit_chain_size: int = Field(0, ge=0, description="Tamanho do audit log.")
    lgpd_consent_total: int = Field(0, ge=0, description="Total de consentimentos LGPD ativos.")
    dlq_pending: int = Field(0, ge=0, description="Total de mensagens pendentes na DLQ.")
