...
_TG_POOL_LOOP_ID: int = 0


def _get_tg_pool() -> httpx.AsyncClient:
    global _TG_HTTP_POOL, _TG_POOL_LOOP_ID
    try:
    ...
    if _TG_HTTP_POOL is None or _TG_POOL_LOOP_ID != current_loop_id:
        ...
        _TG_POOL_LOOP_ID = current_loop_id
