...
def _now_minus_days(days: int) -> datetime:
    """Retorna datetime UTC para 'now - X dias'."""
...
def get_dpo_metrics(
    ...
    # Cross-dialect: usa datetime bounds e bind params (anti SQL-injection)
    ts_30d = _now_minus_days(30)
    ts_1d = _now_minus_days(1)
    ts_5y = _now_minus_days(1825)
