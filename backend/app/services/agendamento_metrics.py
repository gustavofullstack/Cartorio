    ...
    def decorator(func: Callable[..., T]) -> Callable[..., T]:
        def wrapper(*args, **kwargs) -> T:
            ...
            metrics_store.observe_histogram(
                "agendamento_cache_operation_duration_ms", duration_ms, labels=labels
            )

            metrics_store.inc_counter("agendamento_cache_operations_total", labels=labels)
    ...
    def decorator(func: Callable[..., T]) -> Callable[..., T]:
        def wrapper(*args, **kwargs) -> T:
            ...
            try:
                ...
                metrics_store.observe_histogram(
                    "agendamento_operation_duration_ms", duration_ms, labels=labels
                )

                metrics_store.inc_counter("agendamento_operations_total", labels=labels)
